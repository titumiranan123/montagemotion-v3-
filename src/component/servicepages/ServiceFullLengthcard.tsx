    ...
    return (
        <div className='w-full aspect-video rounded-lg sm:rounded-[9.91px] overflow-hidden relative bg-black'>
            <ReactPlayer
                ...
                fallback={<div className="w-full h-full bg-gray-800 flex items-center justify-center">
